...
x_train_origin, _, _ = dp.data_process()
...
# Encoder
x = Conv1D(4, 3, activation='relu', padding='same')(input_img)
x = MaxPooling1D(2, padding='same')(x)
x = Conv1D(6, 3, activation='relu', padding='same')(x)
encoded = MaxPooling1D(2, padding='same')(x)

# Decoder
x = Conv1D(6, 3, activation='relu', padding='same')(encoded)
x = UpSampling1D(2)(x)
